...
export default function RootLayout({ children }: PropsWithChildren) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={cn(
          // ↓ this is the “text that should be in the body”
          "min-h-dvh bg-background text-foreground antialiased",
          montserrat.className, // apply Montserrat to the whole app
          montserratAlternates.variable // keep alternates available via CSS var
        )}
      >
        <ThemeProvider>
